...
import { getDeliveries, createDelivery, validateDelivery } from '../api/deliveries';
...
export default function DeliveriesPage() {
  ...
  function fetchAll() {
    setLoading(true);
    Promise.all([
      getDeliveries(statusFilter ? { status: statusFilter } : {}),
  ...
  async function handleCreate(e) {
    ...
    try {
      ...
      toast.success('Delivery created!', { id: toastId });
      setShowModal(false);
      resetForm();
      fetchAll();
    } catch (err) {
  ...
  async function handleValidate(id) {
    ...
    try {
      ...
      toast.success('Delivery validated — stock decreased!', { id: toastId });
      fetchAll();
    } catch (err) {
      toast.error(
  ...
  return (
    <div>
      ...
      <Table
        ...
        data={deliveries}
        loading={loading}
        emptyMessage="No deliveries yet. Click '+ New Delivery' to create your first one."
      />
          ...
          <form onSubmit={handleCreate}>
            ...
            <div style={{ marginBottom: '16px' }}>
              ...
              <select
                ...
                onChange={(e) =>
                  setForm((p) => ({ ...p, sourceLocationId: e.target.value }))
                }
                style={selectStyle(errors.sourceLocationId)}
              >
              ...
              {errors.sourceLocationId && (
                <span style={errorStyle}>{errors.sourceLocationId}</span>
              )}
            </div>
            ...
            >
              ℹ️ Validating this delivery will automatically decrease stock at the selected location.
            </div>
